import sanpoImage from "figma:asset/a97e6b5c6631c69bf0463a67f2994722a9b13300.png";
import kusakariImage from "figma:asset/c75a506f2b58dcf5f4dc61afeebdbc400b0a6f8a.png";
import taueImage from "figma:asset/23a4bdf51706e94b2cd247e5ad989d6411c83608.png";
import inekariImage from "figma:asset/207a8fdb0ecb3d43739e4e63547e88bed1d255aa.png";
import makiwariImage from "figma:asset/e7040713674f9ba69db8035323989527e8bcf7d9.png";
import vegImage from "figma:asset/2fd9fc84b215a469b3716ab729cd06c3e0a97124.png";
import starsImage from "figma:asset/d736bd7b9fbf79b2b7e3e1acfc214c2d3dd67acf.png";
...
const experiences: Experience[] = [
  {
    ...
    imgHeight: 400,
    specs: [
      { icon: <FaYenSign size={13} />, label: "料金", value: "¥4,500 / 人" },
      { icon: <FaClock size={13} />, label: "所要時間", value: "約 2〜3 時間" },
      { icon: <FaUsers size={13} />, label: "推奨人数", value: "2〜6 名" },
      { icon: <FaCalendarAlt size={13} />, label: "時期", value: "5〜6 月" },
    ],
  ...
  },
  {
    ...
    specs: [
      ...
      { icon: <FaClock size={13} />, label: "所要時間", value: "約 2〜3 時間" },
      { icon: <FaUsers size={13} />, label: "推奨人数", value: "2〜6 名" },
      { icon: <FaCalendarAlt size={13} />, label: "時期", value: "9〜10 月" },
    ],
  ...
  },
  {
    ...
    imgHeight: 400,
    specs: [
      { icon: <FaYenSign size={13} />, label: "料金", value: "¥2,000 / 1 時間" },
      { icon: <FaClock size={13} />, label: "所要時間", value: "1 時間単位" },
  ...
  },
  {
    ...
    imgHeight: 400,
    specs: [
      { icon: <FaYenSign size={13} />, label: "料金", value: "¥1,500 / カゴ" },
      { icon: <FaClock size={13} />, label: "所要時間", value: "約 30〜60 分" },
      { icon: <FaUsers size={13} />, label: "推奨人数", value: "1〜6 名" },
      { icon: <FaCalendarAlt size={13} />, label: "時期", value: "7〜8 月" },
    ],
  ...
  },
  {
    ...
    imgHeight: 400,
    specs: [
      { icon: <FaYenSign size={13} />, label: "グリルレンタル", value: "¥3,500" },
...
const starExp = {
  ...
  imgHeight: 400,
  specs: [
    { icon: <FaYenSign size={13} />, label: "料金", value: "無料（ガイド付き ¥2,000/組）" },
    { icon: <FaClock size={13} />, label: "所要時間", value: "自由（ガイド：約1時間）" },
    { icon: <FaUsers size={13} />, label: "推奨人数", value: "1〜6 名" },
    { icon: <FaCalendarAlt size={13} />, label: "時期", value: "通年（晴天時）" },
  ],
  ...
  const handleLoad = (e: React.SyntheticEvent<HTMLImageElement>) => {
    ...
    if (containerH > 0 && naturalH <= containerH) {
      ...
      if (scaledW >= containerW) {
        setImgStyle({ width: "auto", height: `${containerH}px`, flexShrink: 0, display: "block" });
      } else {
        setImgStyle({ width: "100%", height: "100%", objectFit: "cover", display: "block" });
      }
    } else {
      setImgStyle({ width: "100%", height: "100%", objectFit: "cover", display: "block" });
    }
    ...
    >
      ...
      >
        ...
        <div style={{ padding: "1.75rem 2rem", display: "flex", flexDirection: "column", gap: "1.1rem" }}>
          ...
          {/* 説明文 */}
          <p style={{ fontSize: "0.85rem", color: "#5a4838", lineHeight: 1.95, margin: 0 }}>
            {exp.desc}
          </p>
    ...
    <div>
      ...
      <section style={{ backgroundColor: "#faf5e8", padding: "5rem 1.5rem" }}>
        <div style={{ maxWidth: "900px", margin: "0 auto" }}>
          ...
          >
            {bookingSteps.map((step, i) => (
              ...
              >
                ...
                <p style={{ fontSize: "0.8rem", color: "#5a4838", lineHeight: 1.75 }}>
                  {step.desc}
                </p>
              </div>
            ))}
          ...
          >
            <p style={{ fontSize: "0.82rem", color: "#5a4838", lineHeight: 1.85, margin: 0 }}>
