...
export function ReservationDetail() {
    ...
    const checkinMonthDay = checkin.slice(5);
    const experienceList = experiences
        .filter((experience) => {
            ...
            return experience.periodStart <= experience.periodEnd
                ? checkinMonthDay >= experience.periodStart &&
                      checkinMonthDay <= experience.periodEnd
                : checkinMonthDay >= experience.periodStart ||
                      checkinMonthDay <= experience.periodEnd;
        })
        .map((experience) => ({
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            >
                                        ...
                                        >
                                            ...
                                            {parseInt(form.guests) >= 5 ? (
                                                <>
                                                    ...
                                                    >
                                                        ※ {form.guests}
                                                        名のため追加車両手配費¥5,000が加算されます（人数不問・一律）
                                                    </span>
                                                </>
                                            ) : (
                                                <span
                                ...
                                <button
                                    ...
                                    style={{
                                        width: "100%",
                                        backgroundColor: form.agreement
                                            ? "#5c2e12"
                                            : "#c8b8a0",
                                        color: form.agreement
                                            ? "#f0e8d0"
                                            : "#a09080",
                                        padding: "1.1rem",
                                        borderRadius: "3px",
                                        border: "none",
                                        cursor: form.agreement
                                            ? "pointer"
                                            : "not-allowed",
                                        fontSize: "1rem",
                                        fontWeight: 700,
                                ...
                                >
                                    <div
                                        style={{
                                            padding: "0.4rem 0",
                                            borderBottom:
                                                "1px solid rgba(240,232,208,0.1)",
                                        }}
                                    >
                                        <span
                                            style={{
