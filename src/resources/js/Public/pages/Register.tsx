...
export function Register() {
    ...
    const handleConfirm = () => {
        const userData: UserProfile = {
            ...
            petBreed2:
                profile.hasPet === "small2" ? profile.petBreed2 : undefined,
                                ...
                                <div style={{ marginBottom: "1.75rem" }}>
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {(profile.hasPet === "small" ||
                                                profile.hasPet === "large") && (
                                                <div>
                                                    <label style={labelStyle}>
                                                        犬種
                                                    </label>
                                        ...
                                        {(profile.hasPet === "small2" ||
                                            profile.hasPet === "large2") && (
                                            <div
                                                style={{
                                                    display: "flex",
                                                    flexDirection: "column",
                            ...
                            {[
                                {
                                    ...
                                    items: [
                                        ...
                                        {
                                            label: "ふりがな",
                                            value: `${profile.lastNameKana} ${profile.firstNameKana}`,
                                        },
                                        {
                                            label: "メールアドレス",
                                            value: email,
                                        ...
                                        {
                                            label: "住所",
                                            value: `${profile.postalCode ? `〒${profile.postalCode} ` : ""}${profile.address}`,
                                        },
                                        {
                                            label: "生年月日",
                                            value: profile.birthDate
                                                ? profile.birthDate.replace(
                                                      /^(\d{4})-(\d{1,2})-(\d{1,2})$/,
                                                      (_, y, m, d) =>
                                        ...
                                        {section.items.map((item) => (
                                            <div
                                                ...
                                                style={{
                                                    ...
                                                    padding: "0.5rem 0",
                                                    borderBottom:
                                                        "1px solid rgba(180,140,80,0.08)",
                                                }}
                                            >
                                                <span
                                                    style={{
