...
const fallbackTopNews: TopNewsItem[] = [
    {
        id: "NEWS-006",
        title: "2026年夏シーズン予約受付中",
        content:
            "夏シーズン（6月〜8月）のご予約を受付中です。夏野菜収穫体験・BBQグリルレンタル・星空ガイドなど夏ならではの体験オプションをご用意しています。標高の高い新野は夏でも涼しく、快適にお過ごしいただけます。",
    ...
    },
    {
        ...
        title: "GW期間の予約受付開始",
        content:
            "ゴールデンウィーク期間（4/29〜5/5）の予約受付を開始いたしました。GW期間は特別料金期間となります。田植え体験もあわせてお楽しみください。お早めのご予約をおすすめします。",
    ...
    },
    {
        ...
        title: "星空観察ガイドサービス開始",
        content:
            "新たに星空観察ガイドサービスを開始いたしました。専門スタッフが星座の解説をしながら南信州の夜空をご案内します。ガイドなし（無料）とガイド付き（1組¥2,000）からお選びいただけます。",
        publishDate: "2026-03-01",
    },
    {
        id: "NEWS-001",
        ...
        content:
            "3月1日より2026年シーズンの営業を開始いたします。今シーズンも安心・快適な滞在をご提供できるよう、スタッフ一同心よりお待ちしております。ご不明な点はお問い合わせフォームよりご連絡ください。",
...
export function Home() {
    ...
    return (
        <div>
            ...
            {/* ── Features ── */}
            <section
                style={{ backgroundColor: "#f2e8d0", padding: "6rem 1.5rem" }}
            >
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    <path
                                        d="M14.07 5.93a7 7 0 010 8.14M16.95 3.05a11 11 0 010 13.9"
                                        stroke="#d4b070"
                                        strokeWidth="1.3"
                                        fill="none"
                                        strokeLinecap="round"
            ...
            {/* ── Seasons ── */}
            <section
                style={{ backgroundColor: "#1b2f0e", padding: "6rem 1.5rem" }}
            >
                <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
                    <div
                        style={{ textAlign: "center", marginBottom: "3.5rem" }}
                ...
                <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
                    ...
                    >
                        <div>
                            ...
                            >
                                「El bosque（エル
                                ボスケ）」はスペイン語で「森」。長野県南信州、阿南町新野の巣山湖畔に位置するこのログハウスは、手付かずの森と静かな湖に囲まれた、特別な一棟貸し施設です。
                            </p>
                            <p
                                style={{
                                    color: "#5a4838",
