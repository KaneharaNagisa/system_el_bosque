import bbqPhoto from "../assets/c232c6053b1490db7b5dc90637581a4da86b4682.png";
import cabinPhoto from "../assets/0b3064ec72e9db4af32817c032fdcc52faa8d748.png";
        ...
        <div>
                ...
                <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
                    ...
                    >
                        ...
                        <div>
                            ...
                            >
                                「El bosque（エル
                                ボスケ）」はスペイン語で「森」を意味します。長野県南信州、阿南町新野の巣山湖畔に位置するこのログハウスは、手付かずの森と静かな湖に囲まれた、特別な一棟貸し施設です。
                            </p>
                            <p
                                style={{
                                    color: "#5a4838",
            ...
            >
                <div style={{ maxWidth: "800px", margin: "0 auto" }}>
                    ...
                    >
                        ルールを守ってご利用いただけない場合は、退去をお願いする場合があります。
                        <br />
