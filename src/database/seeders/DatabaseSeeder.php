...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 固定ページ
        $pages = [
            ['title' => '施設紹介',         'slug' => 'about',   'content' => "長野県下伊那郡阿南町新野に位置する一棟貸しログハウス「貸別荘エルボスケ」は、最大6名（推奨1〜4名）まで宿泊可能な完全プライベート空間です。\n\nWi-Fi完備、送迎・買い出しサポート付きで、ペット（小型犬2頭または大型犬1頭）も一緒にお過ごしいただけます。\n\n営業期間は3月〜12月です。", 'status' => 'published'],
            ['title' => '周辺情報',         'slug' => 'area',    'content' => "新野周辺には豊かな自然が広がっています。星空観察スポット、ハイキングコース、地元の温泉など、四季折々の魅力をお楽しみいただけます。",                                                                                                                                                 'status' => 'published'],
